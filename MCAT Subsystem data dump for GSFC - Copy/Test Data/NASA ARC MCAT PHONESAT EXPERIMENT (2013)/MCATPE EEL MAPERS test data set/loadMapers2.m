%% matlab script to load in data from RD532-MAPERS-2 data set
% Samudra Haque, 8/30/2013 samudra@gwu.edu
clear;
close all;
fn='CSV_RD532-MAPERS-2.txt';
delimiterIn=',';
A=importdata(fn,delimiterIn);
[A_rows,A_cols]=size(A);
sampleStart=1; %sample
sampleEnd=A_rows; %sample
timestamp=A(sampleStart:sampleEnd,1); %1st col. of data timestamp
P15=A(sampleStart:sampleEnd,2); %2nd col. of data P15 current draw
P15H=A(sampleStart:sampleEnd,3); %3rd col. of data P15H current draw
